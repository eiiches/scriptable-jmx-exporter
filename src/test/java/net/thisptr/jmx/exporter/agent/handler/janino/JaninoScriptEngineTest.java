...
public class JaninoScriptEngineTest {
	...
	void testSimple() throws Exception {
		...
		sut.compileTransformScript("V1.transform(in, out, \"type\")").execute(sample, metrics::add);
	...
	void testNonExistentKeyProperty() throws Exception {
		...
		final List<PrometheusMetric> metrics = new ArrayList<>();
		sut.compileTransformScript("V1.transform(in, out, \"non_existent_key\")").execute(sample, metrics::add);
	...
	void testAll() throws Exception {
		...
		final TransformScript script1 = sut1.compileTransformScript("V1.transform(in, out, \"type\")");
